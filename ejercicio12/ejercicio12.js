...
var servidor = http.createServer(function(pedido, respuesta) {
    ...
    var camino = "ejercicio12/public" + objetourl.pathname;
    if (camino == "ejercicio12/public/") camino = "ejercicio12/public/index.html";
...
function encaminar(pedido, respuesta, camino) {
    switch (camino) {
        case "ejercicio12/public/listanumeros":
            {
                listar(pedido, respuesta);
                break;
            }
        case "ejercicio12/public/listadotabla":
            {
