...
const servidor = http.createServer((pedido, respuesta) => {
    ...
    let camino = "ejercicio10/public" + objetourl.pathname;
    if (camino == "ejercicio10/public/") camino = "ejercicio10/public/index.html";
...
function encaminar(pedido, respuesta, camino) {
    console.log(camino);
    switch (camino) {
        case "ejercicio10/public/recuperardatos":
            {
